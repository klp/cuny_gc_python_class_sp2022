...
# create a function "only_lower"
# initialize an empty list to store results of list loop
# create loop structure
# condition only add an item from the list if string is alphabetical
# need to convert item to lower case
